module dshr_global_sums_mod

  !-----------------------------------------------------------------------------
  ! Computation of global sums, optionally in a manner that is independent of processor count.
  !
  ! NOTE: This is deliberately duplicated from med_global_sums in
  ! cmeps/mediator/med_global_sums_mod.F90. The duplication is accepted because neither CMEPS nor
  ...
  public :: dshr_global_sums

  character(*), parameter :: u_FILE_u = &
       __FILE__

  ! dshr_global_sums is generic over the number of fields being summed: the 1fld version takes
  ...
  interface dshr_global_sums
     module procedure dshr_global_sums_1fld
     module procedure dshr_global_sums_nflds
  end interface dshr_global_sums

!===============================================================================
contains
!===============================================================================

  subroutine dshr_global_sums_nflds(gcomp, local_summands, global_sums, rc)
    ...
    character(len=*), parameter :: subname = '(dshr_global_sums_nflds)'
    !---------------------------------------------------------------
  ...
  end subroutine dshr_global_sums_nflds

!===============================================================================

  subroutine dshr_global_sums_1fld(gcomp, local_summands, global_sum, rc)

    ! Compute the global sum of the given local summands, for a single field.
    !
    ! This is a convenience wrapper around dshr_global_sums_nflds for the common case of a
    ...
    call dshr_global_sums_nflds(gcomp, summands_2d, global_sums, rc)
    if (chkerr(rc,__LINE__,u_FILE_u)) return
    global_sum = global_sums(1)

  end subroutine dshr_global_sums_1fld

end module dshr_global_sums_mod
